...
RSpec.describe "Services", type: :system do
  ...
  scenario 'features are sorted by platforms' do
    ...
    service1_row = "#{service1_p2.icon} #{service1_p2.name}\n#{service1_p2.url}\n#{service1_p2.platform.name}"
    service2_row = "#{service2_p1.icon} #{service2_p1.name}\n#{service2_p1.url}\n#{service2_p1.platform.name}"
    service3_row = "#{service3_p1.icon} #{service3_p1.name}\n#{service3_p1.url}\n#{service3_p1.platform.name}"
    service4_row = "#{service4_p2.icon} #{service4_p2.name}\n#{service4_p2.url}\n#{service4_p2.platform.name}"
